...
class HomeFragment : Fragment() {
    ...
    private fun onLoginCallback(result: SimpleAuthResult<Void>) {
        ...
        builder.append(if (result.isSuccess) SimpleSession.getAccessToken() + " Login is succeed" else "FAIL / " + result.errorCode + " / " + result.errorMessaage)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        homeIdpType.setOnClickListener {
            ...
            tokenTextView?.setText(idpType?.name ?: "Null")
